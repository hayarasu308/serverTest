...
throw new Error("Module build failed: Error: ENOENT: no such file or directory, open 'C:\\Users\\wataru\\iwara\\node_modules\\@babel\\polyfill\\lib\\index.js'");
...
/* harmony import */ var _socketEvent__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./socketEvent */ "./src/socketEvent.js");
...
const AddForm = ({
  ...
  const {
    name,
    age
  } = store.getState().form; // storeからフォームの内容を取得

  const handleSubmit = async e => {
    e.preventDefault();
    Object(_socketEvent__WEBPACK_IMPORTED_MODULE_2__["addChara"])(name, age);
    store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_1__["initializeForm"])());
  };

  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("form", {
    onSubmit: e => handleSubmit(e)
  }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, "\u540D\u524D:", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    value: name,
    onChange: e => store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_1__["changeName"])(e.target.value))
  })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, "\u5E74\u9F62:", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
    value: age,
    onChange: e => store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_1__["changeAge"])(e.target.value))
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "./node_modules/react/index.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _AddForm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AddForm */ "./src/AddForm.js");
/* harmony import */ var _CharacterList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./CharacterList */ "./src/CharacterList.js");
...
class App extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_AddForm__WEBPACK_IMPORTED_MODULE_1__["default"], {
      store: store
    }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_CharacterList__WEBPACK_IMPORTED_MODULE_2__["default"], {
      store: store
    }));
  }
...
const CharacterList = ({
  ...
  const handleFetchData = async () => {
    store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_1__["requestData"])());
    Object(_socketEvent__WEBPACK_IMPORTED_MODULE_2__["fetchChara"])();
  };
  ...
  const handleUpdateCharacter = (name, type) => {
    ...
    switch (type) {
      case "inc":
        Object(_socketEvent__WEBPACK_IMPORTED_MODULE_2__["updateInc"])(name);
        break;

      case "dec":
        Object(_socketEvent__WEBPACK_IMPORTED_MODULE_2__["updateDec"])(name);
        break;

      case "del":
        if (confirm(`${name}を一覧から削除してもよろしいですか？`)) {
          Object(_socketEvent__WEBPACK_IMPORTED_MODULE_2__["deleteChara"])(name);
        } else {
          store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_1__["receiveDataFailed"])());
        }
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, isFetching ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h2", null, "Now Loading...") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    onClick: () => handleFetchData()
  }, "fetch data"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, characterArray.map(character => react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
    key: character.name
  }, `${character.name} (${character.age})`, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    onClick: () => handleUpdateCharacter(character.name, "dec")
  }, "-"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    onClick: () => handleUpdateCharacter(character.name, "inc")
  }, "+"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
    onClick: () => handleUpdateCharacter(character.name, "del")
  }, "x"))))));
};
...
/*!************************!*\
  !*** ./src/actions.js ***!
  \************************/
/*! exports provided: CHANGE_NAME, CHANGE_AGE, INITIALIZE_FORM, REQUEST_DATA, RECEIVE_DATA_SUCCESS, RECEIVE_DATA_FAILED, changeName, changeAge, initializeForm, requestData, receiveDataSuccess, receiveDataFailed */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CHANGE_NAME", function() { return CHANGE_NAME; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CHANGE_AGE", function() { return CHANGE_AGE; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "INITIALIZE_FORM", function() { return INITIALIZE_FORM; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "REQUEST_DATA", function() { return REQUEST_DATA; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RECEIVE_DATA_SUCCESS", function() { return RECEIVE_DATA_SUCCESS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RECEIVE_DATA_FAILED", function() { return RECEIVE_DATA_FAILED; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "receiveDataSuccess", function() { return receiveDataSuccess; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "receiveDataFailed", function() { return receiveDataFailed; });
const CHANGE_NAME = 'CHANGE_NAME';
const CHANGE_AGE = 'CHANGE_AGE';
const INITIALIZE_FORM = 'INITIALIZE_FORM';
const REQUEST_DATA = 'REQUEST_DATA';
const RECEIVE_DATA_SUCCESS = 'RECEIVE_DATA_SUCCESS';
const RECEIVE_DATA_FAILED = 'RECEIVE_DATA_FAILED'; // action creaters
...
const receiveDataSuccess = characterArray => ({
...
const {
  FETCH_CHARA
} = __webpack_require__(/*! ./socketEvent */ "./src/socketEvent.js");

const logger = Object(redux_logger__WEBPACK_IMPORTED_MODULE_4__["createLogger"])({
  diff: true,
  collapsed: true
});
const store = Object(redux__WEBPACK_IMPORTED_MODULE_3__["createStore"])(_reducer__WEBPACK_IMPORTED_MODULE_5__["default"], Object(redux__WEBPACK_IMPORTED_MODULE_3__["applyMiddleware"])(logger));

const render = () => {
  react_dom__WEBPACK_IMPORTED_MODULE_1___default.a.render(react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_App_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
    store: store
  }), document.getElementById('container'));
};

socket.on(FETCH_CHARA, arr => {
  store.dispatch(Object(_actions__WEBPACK_IMPORTED_MODULE_6__["receiveDataSuccess"])(arr));
});
store.subscribe(() => {
  render();
});
...
const initialState = {
  ...
  characters: {
    isFetching: false,
    // サーバーからキャラクターのリストを取ってきている最中かどうか
...
const formReducer = (state = initialState.form, action) => {
  switch (action.type) {
    case _actions__WEBPACK_IMPORTED_MODULE_1__["CHANGE_NAME"]:
      return { ...state,
        name: action.name // actionのnameプロパティに入力された名前を入れることにする

      };

    case _actions__WEBPACK_IMPORTED_MODULE_1__["CHANGE_AGE"]:
      return { ...state,
        age: action.age // nameと同様

      };

    case _actions__WEBPACK_IMPORTED_MODULE_1__["INITIALIZE_FORM"]:
...
const charactersReducer = (state = initialState.characters, action) => {
  switch (action.type) {
    case _actions__WEBPACK_IMPORTED_MODULE_1__["REQUEST_DATA"]:
      return { ...state,
        isFetching: true
      };

    case _actions__WEBPACK_IMPORTED_MODULE_1__["RECEIVE_DATA_SUCCESS"]:
      return { ...state,
        isFetching: false,
        characterArray: action.characterArray
      };

    case _actions__WEBPACK_IMPORTED_MODULE_1__["RECEIVE_DATA_FAILED"]:
      return { ...state,
        isFetching: false
      };
...
/*!****************************!*\
  !*** ./src/socketEvent.js ***!
  \****************************/
/*! exports provided: addChara, fetchChara, updateInc, updateDec, deleteChara */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addChara", function() { return addChara; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "fetchChara", function() { return fetchChara; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateInc", function() { return updateInc; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "updateDec", function() { return updateDec; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deleteChara", function() { return deleteChara; });
module.exports = {
  ADD_CHARA: "add chara",
...
module.exports = __webpack_require__(/*! C:\Users\wataru\iwara\src\index.js */"./src/index.js");
